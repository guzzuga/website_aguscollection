      ...
      <AnimatePresence mode="wait">
        {status === 'success' ? (
          ...
          >
            ...
            >
              <Check className="h-10 w-10 text-slate-900 dark:text-white" strokeWidth={3} />
            </motion.div>
            <h3 className="mt-6 font-display text-2xl font-bold text-slate-900 dark:text-white">Pesan Terkirim!</h3>
            <p className="mt-2 max-w-sm text-sm leading-relaxed text-slate-600 dark:text-neutral-400">
            ...
            <Button
              ...
              variant="outline"
              className="mt-6 rounded-full border-navy/20 text-slate-900 dark:text-white hover:border-gold/40 hover:bg-gold/5"
            >
              Kirim Pesan Lain
            </Button>
          </motion.div>
          ...
          >
            <div className="grid gap-5 sm:grid-cols-2">
              <div className="space-y-2">
                <Label htmlFor="nama" className="text-sm font-semibold text-slate-900 dark:text-white">
              ...
              <div className="space-y-2">
                <Label htmlFor="whatsapp" className="text-sm font-semibold text-slate-900 dark:text-white">
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              <div className="space-y-2">
                <Label htmlFor="produk" className="text-sm font-semibold text-slate-900 dark:text-white">
              ...
              <div className="space-y-2">
                <Label htmlFor="jumlah" className="text-sm font-semibold text-slate-900 dark:text-white">
            ...
            <div className="space-y-2">
              <Label htmlFor="pesan" className="text-sm font-semibold text-slate-900 dark:text-white">
                Pesan
              </Label>
              <Textarea
                id="pesan"
            ...
            <Button
              ...
              className="w-full rounded-full bg-gold-gradient py-6 text-base text-slate-900 dark:text-white shadow-gold-glow hover:shadow-gold-glow-lg disabled:opacity-70"
            >
              {status === 'loading' ? (
                <>
