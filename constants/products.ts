...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: 'Wearpack Industri (Atasan)',
    category: 'wearpack',
    categoryLabel: 'Wearpack',
    shortDescription: 'Wearpack industri model atasan untuk kerja lapangan dengan ketahanan maksimal.',
    description:
      'Wearpack industri model atasan (baju) yang dirancang untuk kerja lapangan dengan ketahanan maksimal. Bahan tebal dan kuat, jahitan presisi di semua area, dilengkapi kantong fungsional untuk peralatan kerja. Cocok untuk mekanik, teknisi, dan pekerja industri yang membutuhkan proteksi optimal.',
    images: [
    ...
    priceTiers: [
      ...
      { minQty: 50, maxQty: 199, price: 105000, label: '50–199 pcs' },
      { minQty: 200, maxQty: null, price: 95000, label: '200+ pcs' },
    ],
    colors: [
      { name: 'Navy', hex: '#0a0a2e' },
      { name: 'Hitam', hex: '#0f172a' },
    ...
    reviewCount: 37,
    features: [
      'Bahan tebal dan kuat untuk kerja lapangan',
      'Jahitan presisi di semua area',
    ...
    specifications: [
      { label: 'Bahan', value: 'Industrial Canvas 260 gsm' },
      { label: 'Model', value: 'Atasan / Baju' },
      { label: 'Teknik Logo', value: 'Computerized Embroidery' },
      { label: 'MOQ', value: '10 pcs' },
      { label: 'Estimasi Produksi', value: '10–14 hari kerja' },
      { label: 'Pengiriman', value: 'Seluruh Indonesia' },
  ...
  // ─── ROK MERMAID ───────────────────────────────────────────────────────────
  {
    ...
    images: [
      '/images/products/rok-mermaid-highwaist/foto-1.jpg',
    ...
    badge: 'NEW ARRIVAL 🆕',
    features: [
      '✅ Highwaist fit menutupi perut',
      '✅ Mermaid cut feminine (fitted di pinggul, melebar di bawah)',
      '✅ Bahan Bayadine Premium stretch, tidak mudah kusut',
      '✅ Lapisan dalam tidak menerawang',
      '✅ Resleting samping halus + sabuk luar included',
      '✅ Cocok untuk kantor, kondangan, date night',
    ],
    specifications: [
      { label: 'Bahan', value: 'Bayadine Premium + Stretch' },
      { label: 'Tebal Kain', value: '200 gsm' },
      { label: 'Model', value: 'Mermaid Highwaist' },
      { label: 'Panjang', value: '70-73 cm (size dependent)' },
  ...
  },
  {
    ...
    images: [
      '/images/products/rok-mermaid-satin/foto-1.jpg',
      '/images/products/rok-mermaid-satin/foto-2.jpg',
      '/images/products/rok-mermaid-satin/foto-3.jpg',
      '/images/products/rok-mermaid-satin/foto-4.jpg',
    ],
    basePrice: 125000,
    priceTiers: [
    ...
    colors: [
      ...
      { name: 'Navy Royal', hex: '#0a0a2e' },
      { name: 'Maroon Wine', hex: '#7f1d1d' },
      { name: 'Emerald Green', hex: '#047857' },
      { name: 'Gold Champagne', hex: '#fbbf24' },
    ...
    badge: 'LUXURY ✨',
    features: [
      '✅ Satin silk premium dengan shimmer effect elegan',
      '✅ Full lining tidak menerawang',
      '✅ Back slit untuk kemudahan bergerak',
      '✅ Hidden zipper premium',
      '✅ Elastic waistband nyaman',
      '✅ Perfect untuk wedding, gala dinner, formal events',
    ],
    specifications: [
      { label: 'Bahan', value: 'Satin Silk Premium + Full Lining' },
      { label: 'Tebal Kain', value: '220 gsm' },
      { label: 'Model', value: 'Mermaid Luxury dengan Back Slit' },
      { label: 'Panjang', value: '75-79 cm (size dependent)' },
      { label: 'MOQ', value: '1 pcs' },
      { label: 'Estimasi Produksi', value: '3–5 hari kerja' },
      { label: 'Pengiriman', value: 'Seluruh Indonesia' },
    ],
  ...
  // ─── CELANA CUTBRAY ────────────────────────────────────────────────────────
  {
    ...
    images: [
      '/images/products/celana-cutbray-korean/foto-1.jpg',
      '/images/products/celana-cutbray-korean/foto-2.jpg',
      '/images/products/celana-cutbray-korean/foto-3.jpg',
      '/images/products/celana-cutbray-korean/foto-4.jpg',
    ],
    basePrice: 99000,
    priceTiers: [
    ...
    colors: [
      { name: 'Hitam', hex: '#0a0a0a' },
      { name: 'Navy', hex: '#0a0a2e' },
      { name: 'Dark Blue (Denim Look)', hex: '#1e3a5f' },
      { name: 'Cream', hex: '#fef3c7' },
    ...
    badge: 'TRENDING 2026 🔥',
    features: [
      '✅ Highwaist fit yang nyaman',
      '✅ Cutbray/flared dari lutut (efek kaki jenjang)',
      '✅ Cotton Twill Premium stretch 4 arah',
      '✅ Tidak mudah kusut',
      '✅ Saku depan & belakang fungsional',
      '✅ Resleting & kancing premium',
    ],
    specifications: [
      { label: 'Bahan', value: 'Cotton Twill Premium + 2% Spandex' },
      { label: 'Tebal Kain', value: '240 gsm' },
      { label: 'Model', value: 'Cutbray Highwaist Korean Style' },
      { label: 'Panjang', value: '98-104 cm (size dependent)' },
      { label: 'MOQ', value: '1 pcs' },
      { label: 'Estimasi Produksi', value: '3–5 hari kerja' },
      { label: 'Pengiriman', value: 'Seluruh Indonesia' },
    ],
  },
  {
    ...
    images: [
      '/images/products/celana-cutbray-denim/foto-1.jpg',
      '/images/products/celana-cutbray-denim/foto-2.jpg',
      '/images/products/celana-cutbray-denim/foto-3.jpg',
      '/images/products/celana-cutbray-denim/foto-4.jpg',
    ],
    basePrice: 135000,
    priceTiers: [
    ...
    colors: [
      ...
      { name: 'Medium Blue (Classic)', hex: '#3b82f6' },
      { name: 'Dark Blue (Rinse)', hex: '#1e3a5f' },
    ...
    badge: 'PREMIUM DENIM 💎',
    features: [
      '✅ Premium denim 12oz import',
      '✅ Stretch nyaman (98% Cotton + 2% Spandex)',
      '✅ Highwaist fit',
      '✅ Cutbray flare dari lutut',
      '✅ 5 pocket design klasik',
      '✅ Zipper & button fly premium',
      '✅ Tidak mudah fade',
    ],
    specifications: [
      { label: 'Bahan', value: 'Denim Cotton 98% + Spandex 2%' },
      { label: 'Tebal Kain', value: '12oz (380 gsm)' },
      { label: 'Model', value: 'Cutbray Denim Highwaist' },
      { label: 'Panjang', value: '98-105 cm (size dependent)' },
      { label: 'MOQ', value: '1 pcs' },
      { label: 'Estimasi Produksi', value: '3–5 hari kerja' },
      { label: 'Pengiriman', value: 'Seluruh Indonesia' },
    ],
